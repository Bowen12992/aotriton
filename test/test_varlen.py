...
import pytest
import torch
from _common_test import SdpaParams, VarlenSdpaContext
...
def _do_test_varlen(
    N_HEADS, D_HEAD, seqlens_q, seqlens_k, causal, sm_scale, dropout_p, dtype
):
    import numpy as np
    ...
    # Forward
    tri_out, encoded_softmax, _ = varlen_attention(
        q,
        k,
        v,
        seqlens_q,
