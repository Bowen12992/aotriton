...
def parse():
    ...
    parser.add_argument(
        "--out_path", "-o", type=Path, required=True, help="Out filename"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--verbose", "-v", help="Enable vebose output", action="store_true"
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.0,
        help="Maximal time the compiler can run. Passing 0 for indefinite.",
    )
