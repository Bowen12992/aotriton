...
cudaError_t attn_fwd(T4 q,  // batch_size x num_heads x seqlen_q x head_size
...
cudaError_t attn_fwd_compact_varlen(
    T4 q,                  // 1 x num_heads x total_q x head_size, total_q := \sum_{i=0}^{b} s_i
...
cudaError_t attn_bwd(T4 q,  // batch_size x num_heads x seqlen_q x head_size
                     T4 k,  // batch_size x num_heads x seqlen_k x head_size
                     T4 v,  // batch_size x num_heads x seqlen_k x head_size
...
cudaError_t debug_fill_dropout_rng(T4 r,
                                   uint64_t philox_seed,
                                   uint64_t philox_offset,
                                   AOTRITON_NS::Stream stream);

cudaError_t debug_fill_dropout_rng_tensor(T4 r, T0 philox_seed, T0 philox_offset, AOTRITON_NS::Stream stream);
